...
(5) Open in the browser: `http://localhost/ph-scale-basics/ph-scale-basics_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/ph-scale-basics/build/adapted-from-phet/ph-scale-basics_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
