...
<a href="https://phet.colorado.edu/en/simulation/ratio-and-proportion" target="_blank">visit the simulation's web page</a>.

### Try it!

<a href="https://phet.colorado.edu/sims/html/ratio-and-proportion/latest/ratio-and-proportion_en.html" target="_blank">Click here to run "Ratio and Proportion".</a>

<a href="https://phet.colorado.edu/sims/html/ratio-and-proportion/latest/ratio-and-proportion_en.html" target="_blank">
<img src="https://raw.githubusercontent.com/phetsims/ratio-and-proportion/master/assets/ratio-and-proportion-screenshot.png" alt="Screenshot" style="width: 400px;"/>
</a>
...
git clone https://github.com/phetsims/ratio-and-proportion.git
...
(3) Open in the browser: `http://localhost/ratio-and-proportion/build/adapted-from-phet/ratio-and-proportion_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)

### Get Involved

Contact us at our Google Group: <a href="http://groups.google.com/forum/#!forum/developing-interactive-simulations-in-html5" target="_blank">Developing Interactive Simulations in HTML5</a>

Help us improve, create a <a href="http://github.com/phetsims/ratio-and-proportion/issues/new" target="_blank">New Issue</a>
