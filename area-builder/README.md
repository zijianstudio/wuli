...
(5) Open in the browser: `http://localhost/area-builder/area-builder_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)

#### Optional: Build the simulation into a single file

(1) Change directory to the simulation directory: `cd ../area-builder`
...
(3) Open in the browser: `http://localhost/area-builder/build/adapted-from-phet/area-builder_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
