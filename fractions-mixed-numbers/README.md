...
(5) Open in the browser: `http://localhost/fractions-mixed-numbers/fractions-mixed-numbers_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)

#### Optional: Build the simulation into a single file

(1) Change directory to the simulation directory: `cd ../fractions-mixed-numbers`
...
(3) Open in the browser: `http://localhost/fractions-mixed-numbers/build/adapted-from-phet/fractions-mixed-numbers_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
